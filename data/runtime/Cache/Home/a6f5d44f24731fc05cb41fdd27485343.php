...
<style type="text/css">
	...
	.male, .female{width: 40px;display: flex;}
	.whiteBackground,.whiteBackground input,.whiteBackground span{font-size:14px;}
	
	.whiteBackground input{font-size:14px;}
</style>

<body>
	<div class="mui-content p-15">
		<form class="mui-input-group personalForm" name="form0" method="post" action="<?php echo U('personal');?>"  enctype="multipart/form-data">
			<div class="whiteBackground">
				...
				<div class="mui-input-row">
					...
					<div class="sex">
						<p class="male">
							<?php if(($infos["member_list_sex"]) == "1"): ?><img src="home/images/check_button_s.png" />
								<?php else: ?>
								<img src="home/images/check_button_uns.png" /><?php endif; ?>&nbsp;&nbsp;男
						</p>&nbsp;&nbsp;
						<p class="female">
							<?php if(($infos["member_list_sex"]) == "2"): ?><img src="home/images/check_button_s.png" />
								<?php else: ?>
								<img src="home/images/check_button_uns.png" /><?php endif; ?>&nbsp;&nbsp;女
						</p>
		...
		<div class="whiteBackground mt-15">
			<div class="mui-input-row">
				<label>学校</label>
				<input type="text" value="<?php echo ($school_info["name"]); ?>" readonly unselectable="on" onfocus="this.blur()">
