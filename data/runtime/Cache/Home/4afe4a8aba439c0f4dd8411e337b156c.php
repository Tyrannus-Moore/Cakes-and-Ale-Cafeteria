...
<body>
<form class="form-horizontal" name="form0" method="post" action=""  enctype="multipart/form-data">
	...
	<div class="bac-fff mt-15">
		<div class="psyrzList clearfix">
			...
			<input class="fl psyrzInp" maxlength="10" type="text" name="member_name" id="member_name" value="<?php echo ($infos["member_name"]); ?>" placeholder="输入真实姓名" required/>
		</div>
		<div class="psyrzList clearfix">
		...
		<div class="psyrzList clearfix">
			...
			<input class="fl psyrzInp" type="tel" maxlength="11" name="telphone" id="telphone" value="<?php echo ($infos["telphone"]); ?>" placeholder="输入手机号" required/>
		</div>
	</div>
	...
	<div class="bac-fff mt-15">
		<div class="psyrzList clearfix">
			...
			<input class="fl psyrzInp" type="text" maxlength="18" name="id_card" id="id_card" value="<?php echo ($infos["id_card"]); ?>" placeholder="输入身份证号" required/>
		</div>
	</div>
	...
	<div class="bac-fff mt-15 p-10">
		...
		<div class="po-rela">
			...
			<!--<input class="unloadFile" onchange="xmTanUploadImg(this)" type="file" name="card_zheng" value="" />-->
		</div>
	...
	<div class="bac-fff mt-15 p-10">
		...
		<div class="po-rela">
			...
			<!--<input class="unloadFile" onchange="xmTanUploadImg(this)" type="file" name="card_fan" value=""/>-->
		</div>
	</div>
</form>
