...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="admin_group_edit" method="post" action="<?php echo U('admin_group_runedit');?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="title" id="title" value="<?php echo ($group["title"]); ?>" onkeyup="this.value=this.value.replace(/\s+/g,'')" class="col-xs-10 col-sm-4" required/>
					...
					<div class="form-group">
						...
						<div class="col-sm-10" style="padding-top:5px;">
							<input name="status" id="status" value="1"   class="ace ace-switch" type="checkbox"  <?php if($group['status'] == 1): ?>checked<?php endif; ?> />
