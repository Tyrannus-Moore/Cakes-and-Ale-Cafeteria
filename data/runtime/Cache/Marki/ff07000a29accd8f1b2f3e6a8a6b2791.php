            ...
            <div class="col-xs-10 col-sm-10">
                <form name="admin_list_sea" class="form-search" method="post" action="<?php echo U('applyList');?>">
                    <div class="input-group">
                        ...
                        <input type="text" name="search[due_deadline]" class="form-control" value="<?php echo ($search["due_deadline"]); ?>" id="test6" placeholder=" - " readonly/>
                    ...
                    <form class="ajaxForm" id="leftnav" name="leftnav" method="post" action="" >
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dynamic-table">
                            ...
                            <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                    ...
                                    <td class="hidden-sm hidden-xs"><?php echo (date('Y-m-d H:i',$v["application_time"])); ?></td>
                                    <td>
                                        <div class="action-buttons">
                                            <a class="btn btn-minier btn-yellow" href="<?php echo U('applyDetail',array('member_list_id'=>$v['member_list_id'],'p'=>I('p',1)));?>" title="查看详情">
                                                查看详情
                                            </a>
                                        </div>
                                    </td>
