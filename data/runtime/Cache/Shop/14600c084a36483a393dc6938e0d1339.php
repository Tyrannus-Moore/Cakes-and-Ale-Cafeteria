	...
	<div class="page-content" style="padding-top: 50px">
		<div class="row maintop">
			...
			<div class="col-xs-12 col-sm-12">
                <?php if($count < 6): ?><a href=<?php echo U('addressAdd');?>>
						...
						<form class="ajaxForm" name="ruleorder" method="post" action="<?php echo U('admin_rule_order');?>" >
							<table class="table table-striped table-bordered table-hover" id="dynamic-table">
								...
								<?php if(is_array($address)): foreach($address as $key=>$v): ?><tr>
										...
										<td>
											<?php if($v['status'] == 1): ?><a class="red display-btn" href="<?php echo U('address_state');?>" data-id="<?php echo ($v["id"]); ?>" title="显示">
													<div id="zt<?php echo ($v["id"]); ?>"><button class="btn btn-minier btn-yellow">显示</button></div>
												</a>
												<?php else: ?>
												<a class="red display-btn" href="<?php echo U('address_state');?>" data-id="<?php echo ($v["id"]); ?>" title="隐藏">
										...
										<td>
											<div class="hidden-sm hidden-xs action-buttons">
												<a class="green" href="<?php echo U('address_edit',array('id'=>$v['id']));?>" title="修改">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>

												<?php if($v['level'] < 3): ?><a class="blue" href="<?php echo U('addressAdd',array('pid'=>$v['id'],'level'=>$v['level']));?>" title="添加子地点">
												...
												<a class="red confirm-rst-url-btn" href="<?php echo U('address_del',array('id'=>$v['id']));?>" data-info="你确定要删除吗？" title="删除">
											...
											<div class="hidden-md hidden-lg">
												<div class="inline position-relative">
													...
													<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
														<li>
															<a href="<?php echo U('address_edit',array('id'=>$v['id']));?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
																			<span class="green">
														...
														<li>
															<a href="<?php echo U('address_del',array('id'=>$v['id']));?>"  data-info="你确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-original-title="删除">
																			<span class="red">
