...
<div class="page-content" style="padding-top: 50px;">
	...
	<div class="page-header">
		<h1>您当前操作
			<small>
				<i class="ace-icon fa fa-angle-double-right"></i>用户详情
			</small>
		</h1>
	</div>
	<div class="row">
		<div class="col-xs-12">
			<form class="form-horizontal ajaxForm" name="admin_list_add" method="post" action="">
				<input type="hidden" name="stall_id" value="<?php echo ($infos["member_list_id"]); ?>">
				<input type="hidden" name="p" value="<?php echo ($p); ?>">
				<div class="form-group" id="pic_list">
					<label class="col-sm-2 control-label no-padding-right" for="form-field-1">头像： </label>
					<div class="col-sm-10">
						<div><img src="<?php echo ($infos["member_list_headpic"]); ?>" height="70" ></div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" value="<?php echo ($infos["member_list_nickname"]); ?>" placeholder="昵称" maxlength="10" class="col-xs-10 col-sm-5" readonly/>
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<?php if(($infos[member_list_sex]) == "1"): ?><input type="text" value="男" placeholder="性别" class="col-xs-10 col-sm-5" readonly/><?php endif; ?>
						<?php if(($infos[member_list_sex]) == "2"): ?><input type="text" value="女" placeholder="性别" class="col-xs-10 col-sm-5" readonly/><?php endif; ?>
						<?php if(($infos[member_list_sex]) == "3"): ?><input type="text" value="" class="col-xs-10 col-sm-5" readonly/><?php endif; ?>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-10" id="material">
						<input name="birthary_time" id="start_time" value="<?php echo (date('Y-m-d',$infos[birthary_time])); ?>" type="text" required readonly>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" maxlength="20" name="school" value="<?php echo ($infos["name"]); ?>" placeholder="学习名称" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" name="faculty" value="<?php echo ($infos["faculty"]); ?>" placeholder="院系" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" name="member_class" value="<?php echo ($infos["member_class"]); ?>" placeholder="班级" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="number" name="stature" value="<?php echo ($infos["stature"]); ?>" placeholder="身高" class="col-xs-10 col-sm-5" readonly/>
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="number" name="weight" value="<?php echo ($infos["weight"]); ?>" placeholder="体重" class="col-xs-10 col-sm-5" readonly/>
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="number" value="<?php echo ($infos["telphone"]); ?>" placeholder="手机号" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<!--<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" maxlength="18" name="id_card" value="<?php echo ($infos["id_card"]); ?>" placeholder="身份证号" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div><img src="<?php echo ($infos["card_zheng"]); ?>" height="70" ></div>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div><img src="<?php echo ($infos["card_fan"]); ?>" height="70" ></div>
					</div>
				</div>
				<div class="space-4"></div>-->
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" value="<?php echo (date('Y-m-d H:i:s',$infos[addtime])); ?>" placeholder="注册时间" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" value="<?php if($infos[is_open] == 2): ?>冻结<?php else: ?>正常<?php endif; ?>" placeholder="状态" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
