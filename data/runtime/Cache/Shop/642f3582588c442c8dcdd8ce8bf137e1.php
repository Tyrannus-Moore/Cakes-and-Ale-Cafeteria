...
<div id="sidebar" class="sidebar responsive sidebar-fixed">
    ...
    <div class="page-content" style="padding-top: 50px">
        ...
        <div class="page-header">
            <h1>您当前操作
                <small>
                    <i class="ace-icon fa fa-angle-double-right"></i>详情
                </small>
            </h1>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal ajaxForm" name="admin_list_add" method="post" action="<?php echo U('typeEdit');?>">
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 订单编号：  </label>
                        <div class="col-sm-8">
                            <input type="text" value="<?php echo ($infos["order_no"]); ?>" class="col-xs-10 col-sm-5" readonly/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" value="<?php echo ($infos["member_name"]); ?>" class="col-xs-10 col-sm-5" readonly/>
                            <span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" value="<?php echo ($infos["telphone"]); ?>" class="col-xs-10 col-sm-5" readonly/>
                            <span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" value="<?php echo ($infos["stall_name"]); ?>" class="col-xs-10 col-sm-5" readonly/>
                            <span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 菜品评分：  </label>
                        <div class="col-sm-8">
                            <input type="text" value="<?php echo ($infos["dish_score"]); ?>" class="col-xs-10 col-sm-5" readonly/>
                            <span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 服务评分：  </label>
                        <div class="col-sm-8">
                            <input type="text" value="<?php echo ($infos["service_score"]); ?>" class="col-xs-10 col-sm-5" readonly/>
                            <span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 评论时间：  </label>
                        <div class="col-sm-8">
                            <input type="text" value="<?php echo (date("Y-m-d H:i:s",$infos["addtime"])); ?>" class="col-xs-10 col-sm-5" readonly/>
                            <span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 上传图片：  </label>
                        <div class="col-sm-8">
                            <?php if(is_array($imgs)): foreach($imgs as $key=>$vol): ?><a href="<?php echo ($vol); ?>" target="_blank"><img src="<?php echo ($vol); ?>" style="margin: 10px;width:150px;height: 150px" ></a><?php endforeach; endif; ?>
                        </div>
                    </div>
                    <div class="space-4"></div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 评论内容：  </label>
                        <div class="col-sm-8">
                            <textarea class="col-xs-10 col-sm-5" cols="30" rows="10" readonly><?php echo ($infos["content"]); ?></textarea>
                        </div>
                    </div>
                    <div class="space-4"></div>
