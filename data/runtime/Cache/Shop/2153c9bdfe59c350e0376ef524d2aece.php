...
<div class="page-content" style="padding-top: 50px;">
	...
	<div class="page-header">
		<h1>您当前操作
			<small>
				<i class="ace-icon fa fa-angle-double-right"></i>反馈详情
			</small>
		</h1>
	</div>
	<div class="row">
		<div class="col-xs-12">
			<form class="form-horizontal ajaxForm" name="admin_list_add" method="post" action="">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="number" value="<?php echo ($infos["phone"]); ?>" placeholder="手机号" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 反馈时间：  </label>
					<div class="col-sm-7">
						<input type="text" value="<?php echo (date('Y-m-d H:i:s',$infos[addtime])); ?>" placeholder="反馈时间" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 反馈内容：  </label>
					<div class="col-sm-7">
						<textarea cols="54" rows="8" readonly style="resize:none;"><?php echo ($infos["content"]); ?></textarea>
					</div>
				</div>
				<div class="space-4"></div>
