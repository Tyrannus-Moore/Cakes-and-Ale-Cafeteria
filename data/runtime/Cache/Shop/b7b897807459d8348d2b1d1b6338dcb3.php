...
<div id="sidebar" class="sidebar responsive sidebar-fixed">
    ...
    <div class="page-content" style="padding-top: 50px">
        ...
        <div class="page-header">
            <h1>您当前操作
                <small>
                    <i class="ace-icon fa fa-angle-double-right"></i>设置超时时间
                </small>
            </h1>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal ajaxForm" name="admin_list_add" method="post" action="<?php echo U('timeout');?>">
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 超时期限：  </label>
                        <div class="col-sm-8">
                            <input type="number" name="value" value="<?php echo ($value); ?>" step="0.1" class="col-xs-10 col-sm-5" required/>
                            <span class="lbl col-xs-12 col-sm-7"><span class="red">*</span>小时</span>
                        </div>
                    </div>
