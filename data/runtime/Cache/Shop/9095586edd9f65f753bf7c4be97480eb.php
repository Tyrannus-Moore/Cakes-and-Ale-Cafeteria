...
<div id="sidebar" class="sidebar responsive sidebar-fixed">
    ...
    <div class="page-content" style="padding-top: 50px">
        ...
        <div class="page-header">
            <h1>您当前操作
                <small>
                    <i class="ace-icon fa fa-angle-double-right"></i>修改轮播图
                </small>
            </h1>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal ajaxForm" name="admin_list_add" method="post" action="<?php echo U('bannerEdit');?>">
                    <input type="hidden" name="banner_id" value="<?php echo ($infos["banner_id"]); ?>">
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 轮播图名称：  </label>
                        <div class="col-sm-8">
                            <input type="text" name="name" value="<?php echo ($infos["name"]); ?>" placeholder="轮播图名称 限制20字" maxlength="20" class="col-xs-10 col-sm-5" required/>
                    ...
                    <div class="form-group" id="pic_list">
                        ...
                        <div class="col-sm-10">
                            <input type="hidden" name="checkpic" id="checkpic" value="<?php echo ($infos["image"]); ?>" />
                            <input type="hidden" name="oldcheckpic" id="oldcheckpic" value="<?php echo ($infos["image"]); ?>" />
                            ...
                            <span class="lbl col-xs-12 col-sm-7"><span class="red">*图片比例686×340px</span></span>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="url" value="<?php echo ($infos["url"]); ?>" placeholder="链接地址" maxlength="100" class="col-xs-10 col-sm-5" required/>
                            <span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
                        </div>
                    </div>
                    <div class="space-4"></div>
