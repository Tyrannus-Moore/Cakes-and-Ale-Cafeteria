...
<div class="page-content" style="padding-top: 50px;">
    ...
    <div class="row maintop">
        <div class="col-xs-5 col-sm-3">
            <form name="admin_list_sea" class="form-search" method="post" action="<?php echo U('memberList');?>">
                <div class="row maintop">
                    <div class="col-xs-12 col-sm-3 btn-sespan">
                        <div class="input-group">
                            <span class="input-group-addon">昵称：</span>
                            <input type="text" name="search[member_list_nickname]"  class="form-control" value="<?php echo ($search["member_list_nickname"]); ?>" placeholder="昵称" style="width:150px;" />
                            ...
                            <select name="search[is_open]" class="form-control" style="width:80px">
                                ...
                                <option value="1" <?php if($search['is_open'] == 1): ?>selected<?php endif; ?>>正常</option>
                                <option value="2" <?php if($search['is_open'] == 2): ?>selected<?php endif; ?>>冻结</option>
                            </select>
                ...
                <form id="leftnav" name="leftnav" method="post" action="" >
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dynamic-table">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td><?php echo (date("Y-m-d",$v["birthary_time"])); ?></td>
                                <td class="hidden-sm hidden-xs"><?php echo ($v["name"]); ?></td>
                                <td class="hidden-sm hidden-xs"><?php echo ($v["faculty"]); ?></td>
                                <td class="hidden-sm hidden-xs"><?php echo ($v["member_class"]); ?></td>
                                <td class="hidden-sm hidden-xs"><?php echo ($v["telphone"]); ?></td>
                                <td><?php echo (date("Y-m-d H:i:s",$v["addtime"])); ?></td>
                                <td>
                                    <?php if(($v["is_open"]) == "1"): ?>正常<?php endif; ?>
                                    <?php if(($v["is_open"]) == "2"): ?>冻结<?php endif; ?>
                                </td>
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="btn btn-minier btn-success"  href="<?php echo U('memberEdit',array('member_list_id'=>$v['member_list_id'],'p'=>I('p',1)));?>" title="编辑">
                                            编辑
                                        </a>
                                        <?php if($v['is_open'] == 1): ?><a class="red confirm-rst-url-btn btn btn-minier" data-info="你确定要冻结此用户吗？" href="<?php echo U('memberDong',array('member_list_id'=>$v['member_list_id'],'p'=>I('p',1)));?>" title="冻结">
                                                冻结
                                            </a><?php endif; ?>
                                        <?php if($v['is_open'] == 2): ?><a class="red confirm-rst-url-btn btn btn-minier btn-yellow" data-info="你确定要解封此用户吗？" href="<?php echo U('memberJie',array('member_list_id'=>$v['member_list_id'],'p'=>I('p',1)));?>" title="解封">
                                                解封
                                            </a><?php endif; ?>
                                        <a class="red confirm-rst-url-btn btn btn-minier btn-danger" data-info="你确定要删除吗？" href="<?php echo U('memberDel',array('member_list_id'=>$v['member_list_id'],'p'=>I('p',1)));?>" title="删除">
                                            删除
                                        </a>
                                        <a class="btn btn-minier btn-yellow" href="<?php echo U('memberDetail',array('member_list_id'=>$v['member_list_id'],'p'=>I('p',1)));?>" title="查看详情">
                                            查看详情
                                        </a>
                                    </div>
                                </td>
