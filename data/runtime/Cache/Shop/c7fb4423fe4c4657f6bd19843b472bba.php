...
<div class="page-content" style="padding-top: 50px;">
    ...
    <div class="row maintop">
        ...
        <div class="col-xs-5 col-sm-3">
            <form name="admin_list_sea" class="form-search" method="post" action="<?php echo U('stallList');?>">
                <div class="row maintop">
                    <div class="col-xs-12 col-sm-3 btn-sespan">
                        <div class="input-group">
                            <span class="input-group-addon">档口名称：</span>
                            <input type="text" name="search[stall_name]"  class="form-control" value="<?php echo ($search["stall_name"]); ?>" placeholder="档口名称" style="width:130px;" />
                            <span class="input-group-addon">档口电话：</span>
                            <input type="text" name="search[stall_tel]"  class="form-control" value="<?php echo ($search["stall_tel"]); ?>" placeholder="档口电话" style="width:100px;" />
                            <span class="input-group-addon">评分</span>
                            <select name="search[score]" class="form-control" style="width:80px">
                                <option value="">请选择</option>
                                <option value="1" <?php if($search['score'] == 1): ?>selected<?php endif; ?>>1分</option>
                                <option value="2" <?php if($search['score'] == 2): ?>selected<?php endif; ?>>2分</option>
                                <option value="3" <?php if($search['score'] == 3): ?>selected<?php endif; ?>>3分</option>
                                <option value="4" <?php if($search['score'] == 4): ?>selected<?php endif; ?>>4分</option>
                                <option value="5" <?php if($search['score'] == 5): ?>selected<?php endif; ?>>5分</option>
                            </select>
                            <span class="input-group-addon">开始时间：</span>
                            <input name="search[start_time]" id="start_time" class="form-control" value="<?php echo ($search["start_time"]); ?>" type="text" required="required" readonly="readonly" style="width:100px;">
                            <span class="input-group-addon">结束时间：</span>
                            <input name="search[end_time]" id="end_time" class="form-control" type="text"  value="<?php echo ($search["end_time"]); ?>" required="required" readonly="readonly" style="width:100px;">
                ...
                <form id="leftnav" name="leftnav" method="post" action="" >
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dynamic-table">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                <td height="20" ><img src="<?php echo ($v["image"]); ?>" style="width: 60px;"/></td>
                                <td><?php echo ($v["stall_name"]); ?></td>
                                <td class="hidden-sm hidden-xs"><?php echo ($v["stall_tel"]); ?></td>
                                <td class="hidden-sm hidden-xs"><?php echo ($v["score"]); ?></td>
                                <td class="hidden-sm hidden-xs"><?php echo ($v["on_the_pin"]); ?></td>
                                <td><?php echo (date("Y-m-d H:i:s",$v["addtime"])); ?></td>
                                <td><?php echo ($v["sort"]); ?></td>
                                <td>
                                    <?php if(($v["is_freeze"]) == "1"): ?>冻结<?php endif; ?>
                                    <?php if(($v["is_freeze"]) == "2"): ?>正常<?php endif; ?>
                                </td>
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="btn btn-minier btn-success"  href="<?php echo U('stallEdit',array('stall_id'=>$v['stall_id'],'p'=>I('p',1)));?>" title="编辑">
                                            编辑
                                        </a>
                                        <?php if($v['is_freeze'] == 2): ?><a class="red confirm-rst-url-btn btn btn-minier" data-info="你确定要冻结此档口吗？" href="<?php echo U('stallDong',array('stall_id'=>$v['stall_id'],'p'=>I('p',1)));?>" title="冻结">
                                                冻结
                                            </a><?php endif; ?>
                                        <?php if($v['is_freeze'] == 1): ?><a class="red confirm-rst-url-btn btn btn-minier btn-yellow" data-info="你确定要解封此档口吗？" href="<?php echo U('stallJie',array('stall_id'=>$v['stall_id'],'p'=>I('p',1)));?>" title="解封">
                                                解封
                                            </a><?php endif; ?>
                                        <a class="red confirm-rst-url-btn btn btn-minier btn-danger" data-info="你确定要删除吗？" href="<?php echo U('stallDel',array('stall_id'=>$v['stall_id'],'p'=>I('p',1)));?>" title="删除">
                                            删除
                                        </a>
                                        <a class="btn btn-minier btn-yellow" href="<?php echo U('stallDetail',array('stall_id'=>$v['stall_id'],'p'=>I('p',1)));?>" title="查看详情">
                                            查看详情
                                        </a>
                                    </div>
                                </td>
