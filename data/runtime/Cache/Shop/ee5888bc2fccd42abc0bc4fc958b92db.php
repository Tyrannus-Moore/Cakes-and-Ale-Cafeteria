...
<div class="page-content" style="padding-top: 50px;">
    ...
    <div class="row maintop">
        <div class="col-xs-2 col-sm-2">
            <form name="admin_list_sea" class="form-search" method="post" action="<?php echo U('commentList');?>">
                <div class="row maintop">
                    <div class="col-xs-12 col-sm-3 btn-sespan">
                        <div class="input-group">
                            <span class="input-group-addon">订单编号：</span>
                            <input type="text" name="search[order_no]"  class="form-control" value="<?php echo ($search["order_no"]); ?>" placeholder="请输入订单编号" style="width:150px;" />
                            <span class="input-group-addon">档口名称：</span>
                            <input type="text" name="search[stall_name]"  class="form-control" value="<?php echo ($search["stall_name"]); ?>" placeholder="请输入档口名称" style="width:120px;" />
                            <span class="input-group-addon">用户昵称：</span>
                            <input type="text" name="search[member_name]"  class="form-control" value="<?php echo ($search["member_name"]); ?>" placeholder="请输入用户昵称" style="width:120px;" />
                            <span class="input-group-addon">手机号：</span>
                            <input type="text" name="search[telphone]"  class="form-control" value="<?php echo ($search["telphone"]); ?>" placeholder="请输入手机号" style="width:120px;" />
                        </div>
                    </div>
                </div>
                <div class="row maintop">
                ...
                <form id="leftnav" name="leftnav" method="post" action="" >
                    <table class="table table-striped table-bordered table-hover" id="dynamic-table">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td><?php echo ($v["dish_score"]); ?></td>
                                <td><?php echo ($v["service_score"]); ?></td>
                                <td><?php echo (date("Y-m-d H:i:s",$v["addtime"])); ?></td>
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="btn btn-minier btn-info"  href="<?php echo U('comment',array('comment_id'=>$v['comment_id'],'p'=>I('p',1)));?>" title="编辑">
                                            详情
                                        </a>
                                        <a class="red confirm-rst-url-btn btn btn-minier btn-danger" data-info="你确定要删除吗？" href="<?php echo U('commentDel',array('comment_id'=>$v['comment_id'],'p'=>I('p',1)));?>" title="删除">
                                            删除
                                        </a>
                                    </div>
                                </td>
