...
<div id="sidebar" class="sidebar responsive sidebar-fixed">
	...
	<div class="page-content" style="padding-top: 50px">
		...
		<div class="page-header">
			<h1>您当前操作
				<small>
					<i class="ace-icon fa fa-angle-double-right"></i>帮助中心
				</small>
			</h1>
		</div>
		<div class="row">
			<div class="tabbable">
				<ul class="nav nav-tabs" id="myTab">
					<?php if(is_array($class)): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
						<a data-toggle="tab" href="#<?php echo ($v["new_cate_id"]); ?>">
				...
				<form class="form-horizontal setting" name="sys" method="post" action="<?php echo U('runsys');?>">
					<fieldset>
						<div class="tab-content">
							<?php if(is_array($class)): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div id="<?php echo ($v["new_cate_id"]); ?>" class="tab-pane fade">
								<ul class="list-unstyled">
									<?php if(is_array($v["help"])): foreach($v["help"] as $key=>$vo): ?><li>
										<a href="<?php echo U('helpDetail',array('help_id'=>$vo['help_id'],'p'=>I('p',1)));?>">
											<span><?php echo ($key+1); ?>、<?php echo ($vo["help_name"]); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><?php echo (date("Y-m-d",$v["addtime"])); ?></span>
										</a>
	...
	<script>
		...
		$('.tab-content').find('div').first().addClass("in active");
	</script>
