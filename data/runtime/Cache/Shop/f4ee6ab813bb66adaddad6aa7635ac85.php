...
<div class="page-content" style="padding-top: 50px;">
	...
	<div class="page-header">
		<h1>您当前操作
			<small>
				<i class="ace-icon fa fa-angle-double-right"></i>新增档口
			</small>
		</h1>
	</div>
	<div class="row">
		<div class="col-xs-12">
			<form class="form-horizontal ajaxForm" name="admin_list_add" method="post" action="<?php echo U('stallAdd');?>">
				<div class="form-group" id="pic_list">
					...
					<div class="col-sm-10">
						...
						<a href="javascript:;" onclick="return backpic('<?php if($infos["url"] == ''): ?>/public/img/no_img.jpg<?php else: ?><?php echo ($infos["url"]); endif; ?>');" title="还原修改前的图片" class="file">
						撤销上传
						</a>
						<div><img src="<?php if($infos["url"] != ''): ?><?php echo ($infos["url"]); else: ?>/public/img/no_img.jpg<?php endif; ?>" height="70" id="img0" ></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" name="stall_name" placeholder="档口名称" maxlength="10" class="col-xs-10 col-sm-5" required/>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<select name="stall_type" class="col-sm-3" required>
							...
							<option value="1">普通档口</option>
							<option value="2">周餐档口</option>
						</select>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" maxlength="20" name="st_account" placeholder="档口登录账号" class="col-xs-10 col-sm-5" required/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="password" maxlength="20" name="st_pwd" placeholder="档口登录密码" class="col-xs-10 col-sm-5" required/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="number" min="1" maxlength="20" name="stall_tel" placeholder="档口电话" class="col-xs-10 col-sm-5" required/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
