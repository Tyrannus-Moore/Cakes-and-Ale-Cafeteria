...
<div id="sidebar" class="sidebar responsive sidebar-fixed">
    ...
    <div class="page-content" style="padding-top: 50px">
        ...
        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal ajaxFormFo" name="admin_list_add" method="post" action="<?php echo U('foodAdd');?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6" style="display: flex;">
                            <select name="dishes_cate_id" class="form-control" style="width:100px" required>
                                ...
                                <?php if(is_array($dishes_cate_list)): foreach($dishes_cate_list as $key=>$v): ?><option value="<?php echo ($v['dishes_cate_id']); ?>"><?php echo ($v['cat_name']); ?></option><?php endforeach; endif; ?>
                            </select>
                            <span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
                        </div>
                    </div>
