            ...
            <div class="page-content">
                        ...
                        <div class="col-xs-12 col-sm-3 center">
                            <div>
								...
								<span class="profile-picture">
                                        <img id="avatar" class="editable img-responsive" src="/public/img/girl.jpg" width="150" />
								</span>
                                ...
                                <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
                                    <div class="inline position-relative">
                                        ...
                                        &nbsp;
                                        <span class="white"><?php echo ($admin['ma_merchantname']); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="profile-contact-info">
                                <div class="profile-contact-links align-left">
                                    <span id="edit" class="btn btn-link" data-toggle="modal" data-target="#myModaledit" style="margin-left: 35%;">
                            ...
                            <div class="profile-user-info profile-user-info-striped">
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value">
                                        <span class="editable" id="username"><?php echo ($admin['ma_merchantname']); ?></span>													</div>
                                </div>
                                ...
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value">
                                        <span class="editable" id="tel"><?php echo ((isset($admin['ma_tel']) && ($admin['ma_tel'] !== ""))?($admin['ma_tel']):'未设置'); ?></span>													</div>

                                </div>

                                <div class="profile-info-row">
                                    <div class="profile-info-name"> 商家登录地址 </div>

                                    <div class="profile-info-value">
                                        <span class="editable" id="lasttime"><?php echo ($shopAddress); ?></span>													
                                    </div>
                                </div>

                                <!-- <div class="profile-info-row">
                                    <div class="profile-info-name"> 档口地址</div>

                                    <div class="profile-info-value">
                                        <span class="editable" id="loginip"><?php echo ($stallAddress); ?></span>
                                    </div>
                                </div> -->
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value">
                                        <span class="editable" id="loginip"><?php echo (date("Y-m-d",$admin["due_deadline"])); ?></span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal fade in" id="myModaledit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <form class="form-horizontal ajaxForm2" name="admin_runedit" method="post" action="<?php echo U('admin_runedit');?>">
                        <input type="hidden" name="ma_id" value="<?php echo ($admin["ma_id"]); ?>" />
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="admin_pwd" id="admin_pwd" maxlength="15" minlength="6"  class="col-xs-10 col-sm-5" />
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 修改密码：  </label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="edit_pwd" id="edit_pwd" maxlength="15" minlength="6"  class="col-xs-10 col-sm-5" />
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 确定密码：  </label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="confirm_pwd" id="confirm_pwd" maxlength="15" minlength="6"  class="col-xs-10 col-sm-5" />
                                                    <span class="lbl col-xs-12 col-sm-7"><span class="red">*</span>密码必须大于6位，小于15位</span>
                                                </div>
                                            </div>
                                            <div class="space-4"></div>
