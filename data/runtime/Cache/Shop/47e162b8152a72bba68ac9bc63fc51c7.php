...
<div class="page-content" style="padding-top: 50px;">
	...
	<div class="page-header">
		<h1>您当前操作
			<small>
				<i class="ace-icon fa fa-angle-double-right"></i>档口详情
			</small>
		</h1>
	</div>
	<div class="row">
		<div class="col-xs-12">
			<form class="form-horizontal ajaxForm" name="admin_list_add" method="post" action="">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" name="stall_name" value="<?php echo ($infos["stall_name"]); ?>" placeholder="档口名称" maxlength="10" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 档口类型：  </label>
					<div class="col-sm-7">
						<input type="text" name="stall_type" <?php if(($infos["stall_type"]) == "1"): ?>value="普通档口"<?php else: ?>value="周餐档口"<?php endif; ?> placeholder="档口类型" maxlength="10" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 档口登录账号：  </label>
					<div class="col-sm-7">
						<input type="text" maxlength="20" name="st_account" value="<?php echo ($infos["st_account"]); ?>" placeholder="档口登录账号" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 档口登录密码：  </label>
					<div class="col-sm-7">
						<input type="text" maxlength="20" name="st_pwd" value="**************" placeholder="档口登录密码" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="number" min="1" maxlength="20" name="stall_tel" value="<?php echo ($infos["stall_tel"]); ?>" placeholder="档口电话" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="number" min="1" maxlength="20" name="score" value="<?php echo ($infos["score"]); ?>" placeholder="评分" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 上月月销：  </label>
					<div class="col-sm-7">
						<input type="text" min="1" maxlength="20" value="<?php echo ($infos["on_the_pin"]); ?>" placeholder="月销" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" min="1" maxlength="20" value="<?php echo (date('Y-m-d H:i:s',$infos["addtime"])); ?>" placeholder="添加时间" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" value="<?php if($infos[is_freeze] == 1): ?>冻结<?php else: ?>正常<?php endif; ?>" placeholder="状态" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
