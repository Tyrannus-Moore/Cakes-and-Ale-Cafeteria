			...
			<div class="col-xs-12">
				<div class="row">
					...
					<div class="col-sm-7 infobox-container">
						...
						<div class="widget-box sl-indextop10 text-left">
							<div class="widget-header">
								<h5 class="widget-title"><span style="font-size:14px; font-family:Microsoft YaHei">梦诚餐饮</span></h5>
							</div>
							<div class="widget-body">
								<div class="widget-main">
									<p class="alert alert-info sl-line-height25">
										<a href="javascipt:void(0);" target="_blank" alt="SanmiCMF">您已进入梦诚餐饮管理后台</a>
										<br />
									</p>
								</div>
							</div>
