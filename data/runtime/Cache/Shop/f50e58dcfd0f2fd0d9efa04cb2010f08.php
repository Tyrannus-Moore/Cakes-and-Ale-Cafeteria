    ...
    <div class="page-content" style="padding-top: 50px">
        <div class="row maintop">
            <div class="col-xs-12 col-sm-12">
                <?php if($count < 6): ?><a href=<?php echo U('bannerAdd');?>>
            ...
            <div class="col-xs-12">
                <div>
                    <table class="table table-striped table-bordered table-hover" id="dynamic-table">
                        <thead>
                        <tr>
                            <th class="hidden-sm hidden-xs">轮播图名称</th>
                            <th class="hidden-sm hidden-xs">图片</th>
                            <th class="hidden-sm hidden-xs">链接地址</th>
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td class="hidden-sm hidden-xs"><a href="<?php echo ($v["image"]); ?>" target="_blank"><image src="<?php echo ($v["image"]); ?>" style="width:50px;"></image></a></td>
                                <td class="hidden-sm hidden-xs"><?php echo ($v["url"]); ?></td>
                                <td class="hidden-sm hidden-xs">
                                    <a class="btn btn-minier btn-success"  href="<?php echo U('bannerEdit',array('banner_id'=>$v['banner_id'],'p'=>I('p',1)));?>" title="">
                                        编辑
                                    </a>
                                    <a class="btn btn-danger btn-minier confirm-rst-url-btn" href="<?php echo U('bannerDel',array('banner_id'=>$v['banner_id']));?>" data-info="你确定要删除吗？" title="">
                                        删除
                                    </a>
                                </td>
