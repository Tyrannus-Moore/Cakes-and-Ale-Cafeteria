...
<div id="sidebar" class="sidebar responsive sidebar-fixed">
    ...
    <div class="page-content" style="padding-top: 50px">
        ...
        <div class="page-header">
            <h1>您当前操作
                <small>
                    <i class="ace-icon fa fa-angle-double-right"></i>修改地址
                </small>
            </h1>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal ajaxForm" method="post" action="<?php echo U('address_runedit');?>">
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 地址名称：  </label>
                        <div class="col-sm-8">
                            <input type="text" name="title" value="<?php echo ($value["title"]); ?>" maxlength="10" class="col-xs-10 col-sm-5" required/>
