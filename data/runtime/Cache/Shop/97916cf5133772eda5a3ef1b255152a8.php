                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="btn btn-minier btn-success"  href="<?php echo U('discountEdit',array('discount_id'=>$v['discount_id'],'p'=>I('p',1)));?>" title="编辑">
                                            编辑
                                        </a>
                                        <a class="red confirm-rst-url-btn btn btn-minier btn-danger" data-info="你确定要删除吗？" href="<?php echo U('discountDel',array('discount_id'=>$v['discount_id'],'p'=>I('p',1)));?>" title="删除">
                                            删除
                                        </a>
                                    </div>
                                </td>
