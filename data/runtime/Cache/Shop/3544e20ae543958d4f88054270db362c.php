...
<div id="sidebar" class="sidebar responsive sidebar-fixed">
    ...
    <div class="page-content" style="padding-top: 50px">
        ...
        <div class="page-header">
            <h1>您当前操作
                <small>
                    <i class="ace-icon fa fa-angle-double-right"></i>设置餐厅饱和度
                </small>
            </h1>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal ajaxForm" name="admin_list_add" method="post" action="<?php echo U('saturated');?>">
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 餐厅饱和度：  </label>
                        <div class="col-sm-8" style="display: flex;">
                            <select name="status" class="form-control" style="width:100px">
                                <option value="1" <?php if($status == 1): ?>selected<?php endif; ?>>满</option>
                                <option value="2" <?php if($status == 2): ?>selected<?php endif; ?>>少</option>
                                <option value="3" <?php if($status == 3): ?>selected<?php endif; ?>>空</option>
                            </select>
