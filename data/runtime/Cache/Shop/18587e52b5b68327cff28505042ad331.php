...
<div class="page-content" style="padding-top: 50px;">
    ...
    <div class="row maintop">
        <div class="col-xs-5 col-sm-3">
            <form name="admin_list_sea" class="form-search" method="post" action="<?php echo U('packageList');?>">
                <div class="row maintop">
                    <div class="col-xs-12 col-sm-3 btn-sespan">
                        <div class="input-group">
                            ...
                            <select name="search[order_status]" class="form-control" style="width:80px">
                                ...
                                <option value="2" <?php if($search['order_status'] == 2): ?>selected<?php endif; ?>>已支付</option>
                                <!--<option value="3" <?php if($search['order_status'] == 3): ?>selected<?php endif; ?>>待取餐</option>-->
                                <option value="4" <?php if($search['order_status'] == 4): ?>selected<?php endif; ?>>已生效</option>
        ...
        <div class="col-xs-12">
            <div>
                <form id="leftnav" name="leftnav" method="post" action="" >
                    ...
                    <strong>订单总金额：<?php echo ((isset($money) && ($money !== ""))?($money):0); ?>元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><strong>退款金额：<?php echo ((isset($refundMoney) && ($refundMoney !== ""))?($refundMoney):0); ?>元</strong>
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="btn btn-minier btn-yellow" href="<?php echo U('packageDetail',array('order_id'=>$v['order_id'],'p'=>I('p',1)));?>" title="查看详情">
                                            查看详情
                                        </a>
                                    </div>
                                </td>
