...
<div class="page-content" style="padding-top: 50px;">
    ...
    <div class="row maintop">
        ...
        <div class="col-xs-2 col-sm-2">
            <form name="admin_list_sea" class="form-search" method="post" action="<?php echo U('typeList');?>">
                <div class="row maintop">
                    <div class="col-xs-12 col-sm-3 btn-sespan">
                        <div class="input-group">
                            <span class="input-group-addon">分类：</span>
                            <input type="text" name="search[name]"  class="form-control" value="<?php echo ($search["name"]); ?>" placeholder="分类" style="width:150px;" />
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="btn btn-minier btn-success"  href="<?php echo U('typeEdit',array('dishes_cate_id'=>$v['dishes_cate_id'],'p'=>I('p',1)));?>" title="编辑">
                                            编辑
                                        </a>
                                        <a class="red confirm-rst-url-btn btn btn-minier btn-danger" data-info="你确定要删除吗？" href="<?php echo U('typeDel',array('dishes_cate_id'=>$v['dishes_cate_id'],'p'=>I('p',1)));?>" title="删除">
                                            删除
                                        </a>
                                    </div>
                                </td>
