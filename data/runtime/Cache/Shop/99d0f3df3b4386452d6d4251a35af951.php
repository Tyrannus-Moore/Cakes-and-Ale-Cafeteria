...
<div id="sidebar" class="sidebar responsive sidebar-fixed">
    ...
    <div class="page-content" style="padding-top: 50px">
        ...
        <div class="page-header">
            <h1>您当前操作
                <small>
                    <i class="ace-icon fa fa-angle-double-right"></i>添加地区管理
                </small>
            </h1>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal ajaxForm" method="post" action="<?php echo U('addressAdd');?>">
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 地址名称：  </label>
                        <div class="col-sm-8">
                            <input type="text" name="title" placeholder="地址名称 限制10字" maxlength="10" class="col-xs-10 col-sm-5" required/>
                    ...
                    <?php if($row): ?><input name="pid" value="<?php echo ($row['id']); ?>" type="hidden"/>
                        <input name="level" value="<?php echo ($row['level']); ?>" type="hidden"/><?php endif; ?>
