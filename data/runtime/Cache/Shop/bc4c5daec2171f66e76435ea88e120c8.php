...
<div class="page-content" style="padding-top: 50px;">
    ...
    <div class="row maintop">
        <div class="col-xs-5 col-sm-3">
            <form name="admin_list_sea" class="form-search" method="post" action="<?php echo U('applyList');?>">
                <div class="row maintop">
                    <div class="col-xs-12 col-sm-3 btn-sespan">
                        <div class="input-group">
                            <span class="input-group-addon">用户名：</span>
                            <input type="text" name="search[member_name]"  class="form-control" value="<?php echo ($search["member_name"]); ?>" placeholder="用户名" style="width:120px;" />
                            <span class="input-group-addon">手机号：</span>
                            <input type="text" name="search[telphone]"  class="form-control" value="<?php echo ($search["telphone"]); ?>" placeholder="手机号" style="width:110px;" />
                ...
                <form id="leftnav" name="leftnav" method="post" action="" >
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dynamic-table">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td class="hidden-sm hidden-xs"><?php echo (date('Y-m-d H:i:s',$v["application_time"])); ?></td>
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="btn btn-minier btn-success confirm-rst-url-btn" data-info="是否审核通过？" href="<?php echo U('audit_pass',array('member_list_id'=>$v['member_list_id'],'p'=>I('p',1)));?>" title="审核通过" >
                                            通过
                                        </a>
                                        <a class="btn btn-minier btn-info" href="javascript:;" onclick="ifranmek('<?php echo U('withB',array('member_list_id'=>$v['member_list_id'],'p'=>I('p',1)));?>','审核拒绝')" title="审核拒绝">
                                            驳回
                                        </a>
