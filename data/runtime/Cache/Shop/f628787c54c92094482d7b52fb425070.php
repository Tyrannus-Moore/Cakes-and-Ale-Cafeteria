...
<div class="page-content" style="padding-top: 50px;">
	...
	<div class="page-header">
		<h1>您当前操作
			<small>
				<i class="ace-icon fa fa-angle-double-right"></i>结算详情
			</small>
		</h1>
	</div>
	<div class="row">
		<div class="col-xs-12">
			<form class="form-horizontal ajaxForm" name="admin_list_add" method="post" action="">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" value="<?php echo ($infos["order_no"]); ?>" placeholder="订单编号" maxlength="10" class="col-xs-10 col-sm-5" readonly/>
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" value="<?php echo ($infos["stall_name"]); ?>" placeholder="档口名称" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" value="<?php echo ($infos["money"]); ?>" placeholder="档口名称" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 费用类型：  </label>
					<div class="col-sm-7">
						<input type="text" value="<?php if($infos[statue] == 2): ?>支出<?php else: ?>收入<?php endif; ?>" placeholder="费用类型" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 结算类型：  </label>
					<div class="col-sm-7">
						<input type="text"
							<?php if(($infos["state"]) == "1"): ?>value="商户结算（订单金额）"<?php endif; ?>
							<?php if(($infos["state"]) == "2"): ?>value="配送员结算（配送费）"<?php endif; ?>
							<?php if(($infos["state"]) == "3"): ?>value="积分结算（运费）"<?php endif; ?>
						placeholder="结算类型" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" value="<?php echo (date('Y-m-d H:i:s',$infos[creattime])); ?>" placeholder="支付时间" class="col-xs-10 col-sm-5" readonly/>
						<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span></span>
					</div>
				</div>
				<div class="space-4"></div>
